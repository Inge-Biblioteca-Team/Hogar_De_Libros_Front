...
const CreateRooms = () => {
  ...
  return (
    <>
      <Button title="Añadir nueva sala" className="dark:bg-[#2d2d2d] dark:hover:bg-neutral-800 max-sm:w-full lg:w-36 md:w-full" onClick={() => setIsModalOpen(true)} color="blue">
        Añadir sala
      </Button>
