  ...
  return (
    <div className=" grid grid-cols-3  max-w-4xl gap-6">
      ...
      <div className="flex justify-between flex-col max-sm:text-sm max-sm:w-full max-sm:text-center max-sm:items-center col-span-2 text-2xl">
        ...
        <span>
          La biblioteca cuenta con <strong>{computerCount}</strong> computadoras
          las cuales están a disposición de los usuarios de la biblioteca.
        ...
        <div>
          <Button href="/HogarDeLibros/Equipo_Disponible" color={"blue"}>Ver mas información</Button>
        </div>
      </div>
    </div>
  );
