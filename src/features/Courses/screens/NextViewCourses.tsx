...
const NextViewCourses: React.FC = () => {
  ...
  if (isLoading) return <p className="text-center">Cargando cursos...</p>;
  if (error) return <p className="text-center text-red-500">Error al cargar los cursos: {error.message}</p>;
