      ...
      {catalog.count > 0 ? (
        <Table className=" w-full text-center min-h-[30rem] " hoverable>
          <Table.Head>
            ...
            <Table.HeadCell className="2xl:w-1/6 xl:w-1/6 max-sm:hidden" >Autor</Table.HeadCell>
            <Table.HeadCell className="2xl:w-1/6 xl:w-1/6 max-sm:hidden" >ISBN</Table.HeadCell>
