...
const CardViewCollaborators = () => {
    const navigate = useNavigate();

    const handleButtonClick = () => {
        navigate('/HogarDeLibros/ColaboradorFormulario');
    };
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-center mt-4">
                <Button color={'blue'} className="w-36 hover:scale-105 transition-transform duration-300" onClick={handleButtonClick}>
                    ¡Ir al Formulario!
                </Button>
            </div>
        </Card>
...
export default CardViewCollaborators;