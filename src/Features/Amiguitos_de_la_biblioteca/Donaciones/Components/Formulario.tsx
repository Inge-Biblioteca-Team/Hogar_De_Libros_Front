...
function DonationsForm() { // Formulario de donaciones
  return (
    <form className="max-w-md mx-auto  p-6 bg-blueIn rounded-md shadow-md">
      ...
      <button className="bg-blueButton border border-transparent rounded-md p-1" type="submit"> Enviar </button>
      </div>
    </form>
  )
}
