...
function Donaciones() {
  return (
    ...
    <h2 className="text-lg">¿Que son las donaciones?</h2>
    <p>
    ...
    <section className="flex flex-col items-center">
        ...
        <ul>
            ...
            <li>* Los libros que son de aprendizaje de educativo <br />
             deben de tener a lo maximo 4 años de antiguedad de su salida</li>
            <li>* Los libros que contengan acaros o en deterioro no se resiviran</li>
        </ul>
    </section>
    <section  className="flex flex-col items-center"> 
